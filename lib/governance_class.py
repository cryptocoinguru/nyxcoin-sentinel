...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to nyxd "gobject list" output
    ...
    def nyxd_serialise(self):
        import nyxlib
        return nyxlib.SHIM_serialise_for_nyxd(self.serialise())
